                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input id="name" placeholder="John Doe" className="bg-white/5 border-white/10 text-white focus:border-violet-500" required />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="email" className="text-white/80">Email</Label>
                                    <Input id="email" type="email" placeholder="john@empresa.com" className="bg-white/5 border-white/10 text-white focus:border-violet-500" required />
                                </div>
                            </div>

                            <div className="space-y-2">
                                <Label htmlFor="type" className="text-white/80">Interés Principal</Label>
                                <select id="type" className="w-full h-10 px-3 rounded-md bg-white/5 border border-white/10 text-white focus:outline-none focus:ring-1 focus:ring-violet-500">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea id="message" placeholder="Detalles de tu proyecto..." className="min-h-[120px] bg-white/5 border-white/10 text-white focus:border-violet-500" />
                            </div>

                            <Button type="submit" className="w-full h-12 bg-white text-black hover:bg-white/90 font-medium text-lg mt-4">
                                Enviar Solicitud
